  ...
  return ( 
    ...
    <header>
        ...
        <svg style={visMenu ? {display:'none'} : {display:'block'}} onClick={(event)=>{navMenu(event)}} xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
            <path d="M5.42462 5.85938L18.5754 19.0101" stroke="black" stroke-width="1.4"/>
            <path d="M5.42462 19.1406L18.5754 5.98987" stroke="black" stroke-width="1.4"/>
        </svg>
        ...
        <div className={styles.navbar_acount}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M3.76459 6.60889L7.22676 10.0713L10.6891 6.60889" stroke="#757575" stroke-width="1.6"/>
            </svg>
        </div>
        </div>
