...
const Navbar = () => {
  ...
  return ( 
    ...
    <header>
        ...
        <svg style={visMenu ? {display:'block'} : {display:'none'}} onClick={()=>{setVisAcc(true);setVisMenu(false)}} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <svg style={visMenu ? {display:'none'} : {display:'block'}} onClick={()=>{setVisAcc(true);setVisMenu(true)}} xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
        ...
        <svg onClick={()=>{  setVisMenu(true);setVisAcc(!visAcc);}} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M3.76459 6.60889L7.22676 10.0713L10.6891 6.60889" stroke="#757575" strokeWidth="1.6"/>
        </svg>
           
    </div>
        :<svg className={styles.non_acc_nav} onClick={()=>{  setVisMenu(true);setVisAcc(!visAcc)}} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M3.76459 6.60889L7.22676 10.0713L10.6891 6.60889" stroke="#757575" strokeWidth="1.6"/>
        </svg>
